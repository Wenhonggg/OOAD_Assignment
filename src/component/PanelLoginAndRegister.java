...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(){
        ...
        MyTextField txtPasswordConfirm = new MyTextField();
        txtPasswordConfirm.setPrefixIcon(new ImageIcon(getClass().getResource("/icon/pass.png")));
        txtPasswordConfirm.setHint("Confirmed Password");
        register.add(txtPasswordConfirm, "w 60%");
